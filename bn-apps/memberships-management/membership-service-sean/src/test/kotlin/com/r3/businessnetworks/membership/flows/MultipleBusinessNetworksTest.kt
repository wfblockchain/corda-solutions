...
//        val bno4Node = bnoNodes[3]
        ...
        runRequestAndActivateMembershipFlow(id1, bno1Node, multiBnNode)
        runRequestMembershipFlow(id2, bno2Node, multiBnNode)
//        runRequestAndActivateMembershipFlow(bno3Node, multiBnNode)
//        runSuspendMembershipFlow(bno3Node, multiBnNode.identity())

        runRequestAndActivateMembershipFlow(id1, bno1Node, bn1ParticipantNode)
        runRequestAndActivateMembershipFlow(id2, bno2Node, bn2ParticipantNode)
